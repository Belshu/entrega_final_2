 ...
 * salir del programa). Dependiendo del botón que haya pulsado el usuario, un
 * int index tomará un valor diferente y al crear el objeto MenuPrincipal, le
 * pasaremos con su método "setSelectedIndex" para que atuomáticamente aparezca
 * la ventana de gestión correspondiente
 *
...
public class PrimerMenu extends JFrame implements ActionListener {
    ...
    /**
     * Método que devuelve el panel principal donde se colocarán el título de
     * JLabel, el panel de botones. los paneles de márgenes u el JLabel de
     * margen 3. Se modifica la fuente del título para que se vea más grande
     *
     * @return JPanel
     *
     */
    ...
    /**
     * Método principal "main", inicializa las listas de cada menu y el y el
     * constructor de este primer menu. Antes de declarar el constructor se
     * pregunta por terminal si quiere empezar con las listas de ejemplo ya con
     * cierta información en su interior
     *
     * @param args
     *
     */
