...
/**
 * Menu de conceptos al darle al botón de gestionar en la pestaña de las
 * nóminas. Seleccionando una nómina, podrás gestionar sus conceptos y se
 * mostrará en esta interfaz
 *
...
public class MenuConceptos extends JFrame implements ActionListener {
    ...
    /**
     * CONSTRUCTOR: recoge la nómina elegida por el usuario y le asignamos el
     * valor para guardarla
     *
     * @param nomina 
     *
     */
