...
/**
 * Clase que imprime las listas estáticas y las almacena en la carpeta de
 * "Ficheros" del proyecto. La lista que se imprimirá dependerá del constructor
 * que se declare en cada interfaz, sabiéndose así cual es la lista que debe
 * imprimirse (la de los empleados, los partidos...) y si desea que se imprima
 * en un documento .txt o .pdf
 *
...
public class Imprimir extends JFrame implements ActionListener {
    ...
    /**
     * CONSTRUCTOR: declaración de los atributos finales.Declarado especialmente
     * para imprimir los partidos
     *
     * @param index
     *
     */
    public Imprimir(int index) {
    ...
    /**
     * CONSTRUCTOR: declaración de los atributos finales.Declarado especialmente
     * para imprimir los partidos. El boolean que tiene como parámetro decidirá
     * si se trata de los empleados eliminados o no
     *
     * @param eliminados
     *
     */
    ...
    /**
     * Método que devuelve el panel principal donde se colocarán los margenes,
     * el panel secundario y el de los botones
     *
     * @return JPanel
     *
     */
    ...
    /**
     * Método que devuelve el panel secundario donde se colocarán el panel de
     * los radiobuttons
     *
     * @return JPanel
     *
    ...
    /**
     * Método que devuelve el panel de los radiobutton donde se colocarán los
