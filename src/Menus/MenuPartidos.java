...
/**
 * Menu de gestión de partidos: se crea una lista estática que almacena los
 * partidos y para su gestión a base de botones
 *
...
public class MenuPartidos implements ActionListener {
    ...
    *
    ...
    private DefaultListModel getPartidosListModel() {
        ...
        if (!listaPartidos.isEmpty()) {
            for (Partido p : listaPartidos) {
                partidosListModel.addElement(p);
            }
        }
    ...
    /**
     * Método que añade el partido nuevo al cerrar la ventana creada en la
     * interfaz NuevoPartido
     *
     */
