 ...
 * Nomina: - String: el codigo del concepto y su descripción. El código será
 * final - double: el importe del concepto
 *
...
public class Concepto {
     ...
     * @param descripcion String que recoge una breve descripcion para el
