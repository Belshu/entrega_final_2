 ...
 * String: los apellidos del jugador - int: la demarcación y la edad del jugador
 * - double: el valor monetario del jugador - boolea: en estado del jugador si
...
public class Jugador extends Empleado {
    ...
    /**
     * Recoge el DNI, nombre, numero de telefono, apellidos, demarcacion, la
     * edad, el valor del jugador y su estado
     *
